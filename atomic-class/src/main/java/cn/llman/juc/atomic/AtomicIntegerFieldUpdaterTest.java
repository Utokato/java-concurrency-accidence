...
public class AtomicIntegerFieldUpdaterTest {
    ...
    public void testPrivateFieldAccessError() {
        AtomicIntegerFieldUpdater<cn.llman.juc.atomic.TestMe> updater
                = AtomicIntegerFieldUpdater.newUpdater(cn.llman.juc.atomic.TestMe.class, "i");
        cn.llman.juc.atomic.TestMe me = new cn.llman.juc.atomic.TestMe();
    ...
    public void testFiledNameInvalid() {
        AtomicIntegerFieldUpdater<cn.llman.juc.atomic.TestMe> updater
                = AtomicIntegerFieldUpdater.newUpdater(cn.llman.juc.atomic.TestMe.class, "i1");
        updater.compareAndSet(null, 0, 1);
    }
